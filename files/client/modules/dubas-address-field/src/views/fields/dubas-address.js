    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            if (this.isEditMode()) {
                ...
                data.line2MaxLength = this.line2MaxLength;
            }
        ...
        getFormattedAddress1: function () {
            ...
            var line2Value = this.model.get(this.line2Field);
        ...
        afterRender: function () {
            ...
            if (this.mode == 'edit') {
                ...
                this.$line2 = this.$el.find('[data-name="' + this.line2Field + '"]');


                this.$street.on('change', function () {
                    self.trigger('change');
                });
                this.$line2.on('change', function () {
                    self.trigger('change');
                });
        ...
        validateRequired: function () {
            ...
            result = validate(this.line2Field) || result;
        ...
        isRequired: function () {
            return this.model.getFieldParam(this.postalCodeField, 'required') ||
                   ...
                   this.model.getFieldParam(this.line2Field, 'required') ||
        ...
        fetch: function () {
            ...
            data[this.line2Field] = this.$line2.val().toString().trim();
